...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = React.createClass({
		...
		handleClick: function handleClick() {
			...
			console.log("CLICK");
			console.log(this.state.term + this.state.yearStart + this.state.yearEnd);

			// Set the parent to have the search term
			this.props.setTerm(this.state.term, this.state.yearStart, this.state.yearEnd);
		},
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "yearStart", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"h4",
								{ className: "" },
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "yearEnd", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"button",
	...
	var helpers = {
		...
		runQuery: function runQuery(searchTerm, startYear, endYear) {
	  	...
	  	$.ajax({url: queryURL, method: "GET"}) 
			...
			return axios.get(queryURLBase + searchTerm + "&begin_date=" + startYear + "&end_date=" + endYear).then(function (NYTData) {
				console.log(NYTData);
		...
		postHistory: function postHistory(article, yearS, yearE) {

			return axios.post('/api', { location: location, yearS: yearS, yearE: yearE }).then(function (results) {
